...
function Dashboard() {
  ...
  const [rhythmGameSongData, setRhythmGameSongData] = useState<
    RhythmGameSong[]
  >([]);
  const [, setColumns] = useState<{ key: string; label: string }[]>([]);
  ...
  const filteredSongs = useMemo(() => {
    ...
    return rhythmGameSongData.filter(
      (song) =>
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage your rhythm game song database
            </p>
          </div>
            ...
            <CardBody className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      new Set(rhythmGameSongData.map((song) => song.category))
                        .size
                    }
                  </p>
                </div>
            ...
            <CardBody className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {
                      new Set(rhythmGameSongData.map((song) => song.version))
                        .size
                    }
                  </p>
                </div>
                      ...
                      <div className="flex flex-wrap gap-1 max-w-48">
                        {item.difficultyList.map((difficulty) => (
                          <Chip
                            ...
                            color={
                              getDifficultyColor(difficulty.levelName) as any
                            }
                            variant="flat"
                            size="sm"
                          >
